                                   ...
                                   foreach ($productos_datos as $productos_dato){
                                       ...
                                       <tr>
                                           ...
                                           if($stock_actual < $stock_minimo){ ?>
                                               <td class="text-center" style="background-color: #ee868b"><?php echo $productos_dato['stock'];?></td>
                                           <?php
                                           }
                                           else if($stock_actual > $stock_maximo){ ?>
                                               <td class="text-center" style="background-color: #8ac68d"><?php echo $productos_dato['stock'];?></td>
                                           <?php
                                           }else{ ?>
