...
$sentencia = $pdo->prepare("INSERT INTO tb_compras
       ( id_producto, nro_compra, fecha_compra, id_proveedor, comprobante, id_usuario,  cantidad, fyh_creacion) 
VALUES (:id_producto,:nro_compra,:fecha_compra,:id_proveedor,:comprobante,:id_usuario,:cantidad,:fyh_creacion)");
...
if($sentencia->execute()){
    ...
    $_SESSION['mensaje'] = "Se registro la compra de manera correcta";
