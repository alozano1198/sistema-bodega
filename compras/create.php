                                                                       ...
                                                                       <td>
                                                                           ...
                                                                           <script>
                                                                               $('#btn_selecionar<?php echo $id_producto;?>').click(function () {
                                                                                   ...
                                                                                   var email = "<?php echo $productos_dato['nombres'];?>";
                       ...
                       <div class="col-md-12">
                           <div class="card card-outline card-primary">
                               ...
                               <div class="card-body">
                                   ...
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           <button class="btn btn-primary btn-block" id="btn_guardar_compra">Guardar</button>
                                       </div>
                                   </div>
                                   <script>
                                       $('#btn_guardar_compra').click(function () {
                                           ...
                                           if(id_producto == ""){
                                               ...
                                               $.get(url,{id_producto:id_producto,nro_compra:nro_compra,fecha_compra:fecha_compra,id_proveedor:id_proveedor,comprobante:comprobante,id_usuario:id_usuario,cantidad_compra:cantidad_compra,stock_total:stock_total},function (datos) {
