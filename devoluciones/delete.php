...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Detalle de devolución No. <?php echo $nro_devolucion;?> ¿ESTA SEGURO DE ELIMINAR ESTA Devolución?</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                       ...
                       <div class="col-md-3">
                           <div class="card card-outline card-primary">
                               ...
                               <div class="card-body">
                                   ...
                                   <hr>
                                   <div class="form-group">
                                    <button id="btn_borrar_devolucion" class="btn btn-danger btn-block">Borrar</button>
                                    <div id="btn_borrar_devolucion"></div>
                                   </div>                                   
                                   <script>
                                    $('#btn_borrar_devolucion').click(function () {
                                      //alert("click");

                                      var id_devolucion = '<?php echo $id_devolucion_get;?>';

                                      var nro_devolucion = '<?php echo $nro_devolucion_get;?>';
                                      ...
                                      function borrar_devolucion() {
                                        var url = "../app/controllers/devoluciones/borrar_devolucion.php";
                                      $.get(url,{id_devolucion:id_devolucion, nro_devolucion:nro_devolucion},function (datos) {
                                      $('#btn_borrar_devolucion').html(datos);
                                      });
                                      }
